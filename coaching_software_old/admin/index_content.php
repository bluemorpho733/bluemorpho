...
<section class="content-header">
	...
	<section class="col-lg-12">
          <div class="box">
				...
				<h3 class="box-title" style="color:teal;"><i class="fa fa-exclamation-circle"></i>&nbsp;&nbsp;&nbsp;<b><?php echo $language['Important']; ?></b></h3>
				</div>
            <!-- /.box-header -->
				<div class="box-body">
					...
					<a href="javascript:get_content('coaching_info/coaching_info')">
						<div class="col-lg-3 col-xs-6">
						  <div class="small-box" style="background:linear-gradient(to bottom, #00537E 0%, #3AA17E 100%);">
							<div class="inner"><br>
							  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Coaching Info']; ?></h3>
							...
							<a href="javascript:get_content('coaching_info/coaching_info')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
						  </div>
						</div>
					   </a>
					   ...
					   <a href="javascript:get_content('student/students')">
							<div class="col-lg-3 col-xs-6">
							  <div class="small-box" style="background:linear-gradient(to bottom, #45145A  0%, #FF5300 100%);">
								<div class="inner"><br>
								  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Student']; ?></h3>
									<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
								</div>
								<div class="icon">
								...
								<a href="javascript:get_content('student/students')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
							  </div>
							</div>
						</a>
			          ...
			          <a href="javascript:get_content('staff/staff')">
							<div class="col-lg-3 col-xs-6">
							  <div class="small-box" style="background:linear-gradient(to bottom, #3A3897   0%, #A3A1FF 100%);">
								<div class="inner"><br>
								  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Staff']; ?></h3>
									<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
								</div>
								<div class="icon">
								...
								<a href="javascript:get_content('staff/staff')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
							  </div>
							</div>
						</a>
	...
	<section class="col-lg-12 ">
          <div class="box">
				<div class="box-header">
				<h3 class="box-title" style="color:teal;"><i class="fa fa-bar-chart"></i>&nbsp;&nbsp;&nbsp;<b><?php echo $language['Management']; ?></b></h3>
				</div>
				<div class="box-body">
					...
					<a href="javascript:get_content('attendance/attendance')">
							<div class="col-lg-3 col-xs-6">
							  <div class="small-box" style="background:linear-gradient(to bottom, #4F00BC   0%, #29ABE2 100%);">
								<div class="inner"><br>
								  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Attendance']; ?></h3>
									<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
								</div>
								<div class="icon">
								...
								<a href="javascript:get_content('attendance/attendance')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
							  </div>
							</div>
						 </a>
					...
					<a href="javascript:get_content('fees_installmentwise/fees')">
						<div class="col-lg-3 col-xs-6">
						  <div class="small-box" style="background:linear-gradient(to bottom, #00FFA1  0%, #00FFFF 100%);">
							<div class="inner"><br>
							  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Fees']; ?></h3>
								<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
							</div>
							<div class="icon">
							...
							<a href="javascript:get_content('fees_installmentwise/fees')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
						  </div>
						</div>
					</a>
					...
					<a href="javascript:get_content('dues/dues')">
						<div class="col-lg-3 col-xs-6">
						  <div class="small-box" style="background:linear-gradient(to bottom, #662D8C  0%, #ED1E79  100%);">
							<div class="inner"><br>
							  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Dues']; ?></h3>
								<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
							</div>
							<div class="icon">
							...
							<a href="javascript:get_content('dues/dues')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
						  </div>
						</div>
					</a>
					...
					<a href="javascript:get_content('sms/sms_panel')">
						<div class="col-lg-3 col-xs-6">
						  <div class="small-box" style="background:linear-gradient(to bottom, #B066FE  0%, #63E2FF 100%);">
							<div class="inner"><br>
							  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Sms Services']; ?></h3>
								<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
							</div>
							<div class="icon">
							...
							<a href="javascript:get_content('sms/sms')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
						  </div>
						</div>
					</a>
	...
	<section class="col-lg-12 ">
         <div class="box ">
				<div class="box-header">
				<h3 class="box-title" style="color:teal;"><i class="fa fa-book"></i>&nbsp;&nbsp;&nbsp;<b><?php echo $language['Academic']; ?></b></h3>
				</div>
            <div class="box-body">
				...
				<a href="javascript:get_content('certificate/certificate')">
					<div class="col-lg-3 col-xs-6">
					  <div class="small-box" style="background:linear-gradient(to bottom, #009E00  0%, #FFFF96 100%);">
						<div class="inner"><br>
						  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Certificate']; ?></h3>
							<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
						</div>
						<div class="icon">
						...
						<a href="javascript:get_content('certificate/certificate')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
					  </div>
					</div>
				</a>
				...
				<a href="javascript:get_content('examination/examination')">
					<div class="col-lg-3 col-xs-6">
					  <div class="small-box" style="background:linear-gradient(to bottom, #312A6C  0%, #852D91 100%);">
						<div class="inner"><br>
						  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Examination']; ?></h3>
							<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
						</div>
						<div class="icon">
						...
						<a href="javascript:get_content('examination/examination')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
					  </div>
					</div>
				</a>
				...
				<a href="javascript:get_content('time_table/time_table')">
						<div class="col-lg-3 col-xs-6">
						  <div class="small-box" style="background:linear-gradient(to bottom, #FB872B  0%, #D9E021 100%);">
							<div class="inner"><br>
							  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Time Table']; ?></h3>
								<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
							</div>
							<div class="icon">
							...
							<a href="javascript:get_content('time_table/time_table')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
						  </div>
						</div>
					</a>
					...
					<a href="javascript:get_content('library/library')">
							<div class="col-lg-3 col-xs-6">
							  <div class="small-box" style="background:linear-gradient(to bottom, #45145A  0%, #FF5300 100%);">
								<div class="inner"><br>
								  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Library']; ?></h3>
									<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
								</div>
								<div class="icon">
								...
								<a href="javascript:get_content('library/library')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
							  </div>
							</div>
						</a>
	...
	<section class="col-lg-12 ">
        <div class="box ">
				<div class="box-header">
				<h3 class="box-title" style="color:teal;"><i class="fa fa-folder-open-o"></i>&nbsp;&nbsp;&nbsp;<b><?php echo $language['Services']; ?></b></h3>
				</div>
            <div class="box-body">
					...
					<a href="javascript:get_content('complaint/complaint')">
						<div class="col-lg-3 col-xs-6">
						  <div class="small-box" style="background:linear-gradient(to bottom, #93278F 0%, #00A99D 100%);">
							<div class="inner"><br>
							  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Complaints']; ?></h3>
								<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
							</div>
							<div class="icon">
							...
							<a href="javascript:get_content('complaint/complaint')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
						  </div>
						</div>
					</a>
					...
					<a href="javascript:get_content('gallery/gallery')">
						<div class="col-lg-3 col-xs-6">
						  <div class="small-box" style="background:linear-gradient(to bottom, #ED1C24  0%, #FCEE21 100%);">
							<div class="inner"><br>
							  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Gallery']; ?></h3>
								<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
							</div>
							<div class="icon">
							...
							<a href="javascript:get_content('gallery/gallery')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
						  </div>
						</div>
					</a>
				...
				<a href="javascript:get_content('downloads/downloads')">
					<div class="col-lg-3 col-xs-6">
					  <div class="small-box" style="background:linear-gradient(to bottom, #4F00BC  0%, #29ABE2 100%);">
						<div class="inner"><br>
						  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Downloads']; ?></h3>
							<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
						</div>
						<div class="icon">
						...
						<a href="javascript:get_content('downloads/downloads')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
					  </div>
					</div>
				</a>
			        ...
			        <a href="javascript:get_content('stock/stock')">
							<div class="col-lg-3 col-xs-6">
							  <div class="small-box" style="background:linear-gradient(to bottom, #009245  0%, #FCEE21 100%);">
								<div class="inner"><br>
								  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Stock']; ?></h3>
									<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
								</div>
								<div class="icon">
								...
								<a href="javascript:get_content('stock/stock')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
							  </div>
							</div>
						</a>
	...
	<!-------------------------------------- Backup Panel Start --------------------------------->
		<section class="col-lg-12 ">
          <div class="box">
				<div class="box-header">
				<h3 class="box-title" style="color:teal;"><i class="fa fa-rocket"></i>&nbsp;&nbsp;&nbsp;<b><?php echo $language['Other']; ?></b></h3>
				</div>
            <div class="box-body">
				...
				<a href="javascript:get_content('reminder/reminder')">
						<div class="col-lg-3 col-xs-6">
						  <div class="small-box" style="background:linear-gradient(to bottom, #45145A  0%, #FF5300 100%);">
							<div class="inner"><br>
							  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Reminder']; ?></h3>
								<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
							</div>
							<div class="icon">
							...
							<a href="javascript:get_content('reminder/reminder')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
						  </div>
						</div>
				</a>
				...
				<a href="javascript:get_content('recycle_bin/recycle_bin')">
					<div class="col-lg-3 col-xs-6">
					  <div class="small-box" style="background:linear-gradient(to bottom, #00537E 0%, #3AA17E 100%);">
						<div class="inner"><br>
						  <h3 style="font-size:20px;margin-left:10px;color:#fff;"><?php echo $language['Recycle Bin']; ?></h3>
							<p style="margin-left:10px;color:#fff;"><?php echo $language['Enter']; ?></p>
						</div>
						<div class="icon">
						...
						<a href="javascript:get_content('recycle_bin/recycle_bin')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
					  </div>
					</div>
				 </a>
				 <a href="javascript:get_content('holiday/holiday')">
					<div class="col-lg-3 col-xs-6">
					  <div class="small-box" style="background:linear-gradient(to bottom, #3A3897  0%, #A3A1FF 100%);">
						...
						<a href="javascript:get_content('holiday/holiday')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
					  </div>
					</div>
				 </a>
