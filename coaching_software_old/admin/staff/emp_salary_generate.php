...
$("#total_days_in_month").val(res[11]);
...
var final_salary=parseFloat(salary_without_pf)+parseFloat(total_incentive)+parseFloat(allowance)+parseFloat(hra_amount)+parseFloat(da_amount)-parseFloat(other_deduction)-parseFloat(ptax_deduction)-parseFloat(pf_deduction)-parseFloat(tds_deduction)-parseFloat(esic_deduction)-parseFloat(total_advance);
var total_deduction=parseFloat(other_deduction)+parseFloat(ptax_deduction)+parseFloat(pf_deduction)+parseFloat(tds_deduction)+parseFloat(esic_deduction);
...
alert('Sorry ! Entered value Greater than Leave !!!');
$('#verify_total_leaves').val('0');
}
}
    ...
    <div class="box-body">
				<div class="col-md-6 ">
				  ...
				  <div class="panel-body">
					...
					<div class="form-group" >
					  <label  > HRA:</label>
					  <td><input type="text" name="hra_amount" id="hra_amount" placeholder="HRA" class="form-control" value='0' oninput='salary_calculation();' ></td>
					</div>
					</div>
					<div class="col-md-6 ">	
					<div class="form-group" >
					  <label  > DA:</label>
					  <td><input type="text" name="da_amount" id="da_amount" placeholder="HRA" class="form-control" value='0' oninput='salary_calculation();'  ></td>
					</div>
					</div>
					<div class="col-md-6 ">				
					<div class="form-group" >
	       ...
	       <div class="col-md-6 ">				
					<div class="form-group" >
					  ...
					  <td><input type="text" name="allowance1" id='allowance1' placeholder="Allowance" class="form-control" oninput='salary_calculation();' value="0"></td>
					</div>
					</div>       
					<div class="col-md-6 ">				
					<div class="form-group" >
				...
				<div class="form-group">
				   ...
				   <input type="text" name="pf_amount_input1" class="form-control" id="pf_amount_input1" oninput="for_pf();" />
                   <input type="hidden" name="pf_amount_input" class="form-control" id="pf_amount_input" oninput='salary_calculation();' value="0">
					<span class="input-group-addon" style="padding:0px;">
					<select name="pf_method" id="pf_method" style="border:none;" class="" onchange="for_pf();">
					<option value="%">%</option>
			...
			<div class="col-md-6 ">				
				<div class="form-group">
                  ...
                  <input type="text" name="tds_amount_input" class="form-control"  id="tds_amount_input"  oninput='salary_calculation();' value="0">
			        </select>
                </div>
			</div>
			...
			<div class="col-md-6 ">				
				<div class="form-group">
                  ...
                  <input type="text" name="esic_amount_input" class="form-control" id="esic_amount_input" oninput='salary_calculation();' value="0">
                </div>
			</div>
			...
			<div class="col-md-6 ">				
				<div class="form-group">
                 ...
                 <input type="text" name="ptax_amount_input" class="form-control" id="ptax_amount_input" oninput='salary_calculation();' value="0">
                </div>
			</div>
       ...
       <div class="col-md-6 "  >			
					...
					<div class="form-group" >
					  ...
					  <td><input type="text" name="cheque_bank_name" class="form-control" placeholder="Bank Name" value=""></td>
					</div>
					</div>
					...
					<div class="form-group" >
					  <label  > Bank Name </label>
					  <td><input type="text" name="neft_bank_name" class="form-control" placeholder="Bank Name" value=""></td>
					</div>
					</div>
					<div class="col-md-6 " id="for_neft_account_no" style="display:none;">				
					<div class="form-group" >
					  <label  > Account No .</label>
					  <td><input type="text" name="neft_bank_account_no" class="form-control" placeholder="Account No." value=""></td>
					</div>
					</div>
					<div class="col-md-2 ">				
					<div class="form-group" >
				  ...
				  <div class="panel panel-default">
				   ...
				   <div class="col-md-3 ">				
					<div class="form-group" >
					  ...
					  <input type="hidden" name="total_total_days" id="total_total_days" class="form-control" value=""> <input type="hidden" name="total_days_in_month" id="total_days_in_month" class="form-control" oninput='salary_calculation();' value="">
					</div>
					</div>
					<div class="col-md-3 ">				
					<div class="form-group" >
		...
		<div class="col-md-12">
		        <center><button type="submit" name="submit" class="btn  my_background_color"> Submit </button></center>
		</div>
	</div>
