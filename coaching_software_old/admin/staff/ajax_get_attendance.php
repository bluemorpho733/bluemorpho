...
$query2="select * from staff_attendance where staff_id='$staff_id' and month='$frommonth' and year='$fromyear' and session_value='$session1'";
$res2=mysqli_query($conn37,$query2) or die(mysqli_error($conn37));
...
$query1="select * from staff_attendance where staff_id='$staff_id' and month='$tomonth' and year='$toyear' and session_value='$session1'";
...
$holiday_date[$total_holiday_days]=$date3;
 ...
 $query="select * from staff_attendance where staff_id='$staff_id' and month='$frommonth' and year='$fromyear' and session_value='$session1'";

$res=mysqli_query($conn37,$query) or die(mysqli_error($conn37));
