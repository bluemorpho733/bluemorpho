...
<script>
    function check_date(holiday){ 
     		...
     		if(detail!=0){
			alert("This Date has Aleardy Exist in Holiday List. You can Edit it");
			$('#holiday').val('');
			}
              }
           });
				...
				<div class="col-md-4 ">
						<div class="form-group">
						  <label><?php echo $language['Date']; ?><font style="color:red"><b>*</b></font></label>
						   <input type="date"  name="date"  id="holiday" onchange="check_date(this.value)" placeholder="<?php echo $language['Date']; ?>"  value="<?php echo date('Y-m-d');?>" class="form-control" required />
						</div>
							</div>
		...
		<tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $last_updated_date; ?></td>
			         ...
			         <td><button type="button"  onclick="post_content('holiday/edit_holiday','<?php echo 'id='.$s_no; ?>')" class="btn btn-default my_background_color" ><?php echo $language['Edit']; ?></button>
