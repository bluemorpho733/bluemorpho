...
//$('#printTable').print();
  ...
  <li><a href="javascript:get_content('downloads/downloads')"><i class="fa fa-phone-square"></i>Download panel</a></li>
	    <li><a href="javascript:get_content('downloads/student_tc_cbse')"><i class="fa fa-stack-overflow"></i>Student TC</a></li>
    ...
    <section class="content">
	 ...
	 $query="select s_no$info_column_name from student_tc_cbse where session_value='$session1' and student_tc_status='Active'$condition1$condition2$condition3$filter37";
        ...
        <!-- /.col -->
			  ...
			  <div class="col-sm-12">
			  <div class="col-sm-6">
			  <center><button type="button" class="btn my_background_color" onclick="exportTableToExcel('printTable', 'Student TC Report')"><i class="fa fa-print" aria-hidden="true"></i>  Print In Excel</button></center>
			  </div>
			  <div class="col-sm-6">
