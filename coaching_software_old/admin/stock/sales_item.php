		...
		<form role="form" method="post" enctype="multipart/form-data" id="my_form">
		    ...
		    <div class="col-md-3 ">				
				<div class="form-group" >
				  <label ><?php echo $language['Student Name']; ?> <font style="color:red"><b>*</b></font></label>
					<select type="text" name="student_name" id="student_name" onchange="student_details(this.value);" value="<?php echo $student_name; ?>" class="form-control select2" style="width:100%" required>
					<option value="">Select</option>
				  
					<?php
					    $que4="select * from student_admission_info where registration_final='yes' and student_status='Active'";
						...
						echo "<option value='".$s_no."'>".$student_name." [".$course_code."]</option>";
						}
						?>
					</select>
				</div>
			...
			<div class="col-md-3 ">				
					<div class="form-group" >
					  ...
					  <input type="text" name="student_class" placeholder="Courses" id="student_class"; value=""; class="form-control">
					</div>
			</div>
