...
mysqli_query($conn37,$query12);

$query10="select * from stock_buy_table_1 where s_no='$p_name'";
$res10=mysqli_query($conn37,$query10);
$row=mysqli_fetch_assoc($res10);
$item_quantity=$row['item_quantity'];

$stock_quantity=$delete_quantity+$item_quantity;
$query11="update stock_buy_table_1 set item_quantity='$stock_quantity' where s_no='$p_name'";
mysqli_query($conn37,$query11);
	 
if(mysqli_query($conn37,$query12)){
