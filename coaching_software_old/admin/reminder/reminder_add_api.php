<?php include("../attachment/session.php");
	...
	echo $quer="insert into reminder(reminder_allocated_date,reminder_finish_date,reminder_task_1,reminder_task_2,reminder_task_3,reminder_task_4,reminder_task_5,reminder_remark,session_value,$update_by_insert_sql_column)
