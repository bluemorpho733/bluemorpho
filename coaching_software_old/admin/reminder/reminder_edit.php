...
$que="select * from reminder where s_no='$s_no1' and session_value='$session1'";
...
window.scrollTo(0, 0);
    ...
    <h1>
     ...
     <ol class="breadcrumb">
	   ...
	   <li><a href="javascript:get_content('reminder/reminder_list')"><i class="fa fa-list"></i> <?php echo $language['Reminder List']; ?></a></li>
        <li class="active"><i class="fa fa-edit"></i> <?php echo $language['Reminder Edit']; ?></li>
     </ol>
     </section>
       ...
       <h3 class="box-title"><?php echo $language['Reminder Edit']; ?></h3>
       </div>
     ...
     <!------------------------------------------------Start Registration form--------------------------------------------------->
                  ...
                  <label for="reminder_task_1"><?php echo $language['Reminder Task 1']; ?></label>
                  <input type="text" name="reminder_task_1" class="form-control bordder-color" id="" placeholder="Write Task" value="<?php echo $reminder_task_1; ?>" >
                 </div>
				 </div>
				 <div class="col-md-4 ">
				  <div class="form-group" id="for_task_2">
                  <label for="reminder_task_2"><?php echo $language['Reminder Task 2']; ?></label>
                  <input type="text" name="reminder_task_2" class="form-control bordder-color" id="" placeholder="Write Task" value="<?php echo $reminder_task_2; ?>" >
                 </div>
				 </div>
				 <div class="col-md-4 ">
				  <div class="form-group" id="for_task_3">
                  <label for="reminder_task_3"><?php echo $language['Reminder Task 3']; ?></label>
                  <input type="text" name="reminder_task_3" class="form-control bordder-color" id="" placeholder="Write Task" value="<?php echo $reminder_task_3; ?>" >
                 </div>
				 </div>
				 <div class="col-md-4 ">
				  <div class="form-group" id="for_task_4">
                  <label for="reminder_task_4"><?php echo $language['Reminder Task 4']; ?></label>
                  <input type="text" name="reminder_task_4" class="form-control bordder-color" id="" placeholder="Write Task" value="<?php echo $reminder_task_4; ?>" >
                 </div>
				 </div>
				 <div class="col-md-4 ">
				  <div class="form-group" id="for_task_5">
                  <label for="reminder_task_5"><?php echo $language['Reminder Task 5']; ?></label>
                  <input type="text" name="reminder_task_5" class="form-control bordder-color" id="" placeholder="Write Task" value="<?php echo $reminder_task_5; ?>" >
                 </div>
				 </div>
				 <div class="col-md-4 ">	
				   ...
				   <div class="col-md-4 ">		
						<div class="form-group">
						  <label><?php echo $language['Remark']; ?></label>
						   <input type="text" name="reminder_remark" placeholder="Enquiry Remark 2"  value="<?php echo $reminder_remark; ?>" class="form-control">
						</div>
					</div>
