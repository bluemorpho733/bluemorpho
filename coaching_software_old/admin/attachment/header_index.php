...
<header class="main-header" >
    ...
    <a href="main.php" class="logo" style="background:linear-gradient(to bottom, #4F00BC, #29ABE2 );">
      ...
      <span class="logo-mini" id="coaching_name234" >SIMPTION1</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg" id="coaching_name234" >SIMPTION</span>
...
<h4 id="coaching_name" style="color:white;  margin-bottom:-50px; padding-left:35px; padding-right:50px;"><b><?php   echo $coaching_info_coaching_name; ?></b></h4> </br>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $coaching_info_username; ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
				  ...
				  <small><?php echo $coaching_info_coaching_contact; ?></small>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="javascript:get_content('coaching_info/coaching_info_general')" class="btn btn-default btn-flat">Profile</a>
                </div>
     ...
     <div class="navbar-custom-menu ">
       ...
       <li class="dropdown col-md-12">
		     ...
		     <form  method="post" enctype="multipart/form-data" >
				...
				$session_value12321=explode('_',$session_value1232);
				$session_show=$session_value12321[0].'-'.$session_value12321[1];
							
							?>
							
					           <option  <?php if($session12==$session_value1232){ echo 'selected'; }?> value="<?php echo $session_value1232; ?>"> <?php echo $session_show; ?></option>
					        	 <?php } ?>
