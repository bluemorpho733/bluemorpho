...
<?php
$que="select * from student_attendance where attendance_class='$class' and month='$month' and attendance_roll_no='$unique_id' and session_value='$session1'$filter37";
...
<?php
$que="select * from student_attendance where attendance_class='$class' and attendance_roll_no='$unique_id' and session_value='$session1'$filter37";
$run=mysqli_query($conn37,$que) or die(mysqli_error($conn37));
while($row=mysqli_fetch_assoc($run)){
