...
post_content('attendance/emp_registerwise_attendance_update',data12);
    ...
    get_content(loader_div);
        $.ajax({
            url: access_link+"attendance/emp_registerwise_attendance_update_api.php",
            type: "POST",
            data: formdata,
            ...
            success: function(detail){
			   ...
			   if(res[1]=='success'){
				   ...
				   post_content('attendance/emp_registerwise_attendance_list',res[2]);
            }
			}
         });
      });
        ...
        <div class="box" style="padding:10px 10px 10px 10px;">
            ...
            <div class="box-body ">
			  ...
			  <table id="" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
				$que13="select * from employee_info where emp_status='Active' and emp_attendance_register='$staff_type' ORDER BY emp_attendance_priority ASC";
