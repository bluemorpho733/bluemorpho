...
$query="update staff_attendance set `$col_name11`='$in_time[$i]', `$staff_attendance_date4`='$staff_attendance[$i]',$update_by_update_sql where month='$month' and year='$year' and staff_id='$staff_id[$i]' and session_value='$session1'";
