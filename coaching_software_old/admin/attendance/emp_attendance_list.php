...
var data12="staff_type="+staff_type+"&date="+new_date;
    ...
    <section class="content-header">
	 ...
	 <li class="active"><?php echo $language['Employee Attendance List']; ?></li>
      </ol>
    </section>
	<!---*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************-->
    <!-- Main content -->
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped" style="width: 1400px; overflow: auto;">
                ...
                <tr>
                  ...
                  <th><?php echo $language['Staff Type']; ?> : <?php echo $staff_type; ?></th>
                </tr>
                </thead>
                <tbody id="stud_list">
                <tr>
				...
				$que="select * from staff_attendance where staff_type='$staff_type' and month='$current_month' and year='$year1' and session_value='$session1' order by staff_name ASC";
