...
while($row=mysqli_fetch_assoc($run15)){
    ...
    $res01=mysqli_query($conn37,$query01) or die(mysqli_error($conn37));
	...
	echo $student_name."|?|".$student_class."|?|".$student_class_section."|?|".$student_father_name."|?|".$student_mother_name."|?|".$student_date_of_birth."|?|".$student_date_of_birth_in_word."|?|".$student_sssmid_number."|?|".$student_date_of_admission."|?|".$student_admission_number."|?|".$school_roll_no."|?|".$student_admission_class."|?|".$student_class."|?|".$student_adhar_number."|?|".$student_category."|?|".$num."|?|".$total_attendance."|?|".$total_present;
	}
?>