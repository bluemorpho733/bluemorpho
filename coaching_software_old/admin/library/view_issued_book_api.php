<?php 
 ...
 $remark=$_POST['remark'];
   ...
   $query22="select * from school_library_book where book_id_no='$book_id_no'";
    $run22=mysqli_query($conn37,$query22);
    while($row22=mysqli_fetch_assoc($run22)){
    echo $no_of_copy=$row22['no_of_copy'];
	}
  $no_of_copy1=$no_of_copy+1; 
  
 $query="update issue_book set penalty='$penalty',return_date='$date_of_return',remark='$remark',status='Deactive',$update_by_update_sql where student_roll_no='$student'";
