...
if($horizontal>2 && $vertical>1){
  ...
  $width=$width1*$horizontal;
		...
		$this->Image('../id_card_image/id_card_full_background_4.png',10+$width,10+$height,52,82);
		
		
		$this->Image('../id_card_image/id_card_background_header_4.png',10+$width,10+$height,52,14.5);
		...
		$this->Image('../id_card_image/id_card_background_footer_4.png',10+$width,78+$height,52,14);	
