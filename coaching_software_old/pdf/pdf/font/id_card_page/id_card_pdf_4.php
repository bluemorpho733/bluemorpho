...
$count=count($roll_no);
for($j=0;$j<$count;$j++){
$que1="select * from student_admission_info where student_roll_no='$roll_no[$j]'";
...
if($horizontal>2 && $vertical>1){
  ...
  $width=$width1*$horizontal;
        ...
        $this->Image('../id_card_image/id_card_full_background_2.png',10+$width,10+$height,52,82);
  
		$this->Image('../id_card_image/id_card_background_header_2.png',10+$width,10+$height,52.5,15.5);
		...
		$this->Image('../id_card_image/id_card_background_footer_2.png',9.8+$width,72+$height,52.2,20);	
...
$this->SetLeftMargin(10+$width);  
		...
		$this->Ln();
		$this->Cell(21,6,'School Code -',0,0,'C');
		$this->Cell(10,6,'',0,0,'C');
		$this->Cell(21,6,''.$school_info_school_code,0,0,'C');
		$this->Ln();
		
		//--------------------------------------------
		
		$this->Cell(52,7,'',0,0,'C');
		$this->Ln();
		...
		$this->SetTextColor(255,255,255);
		$this->Cell(32,7,'School Contact No.  - ',0,0,'R');
		$this->SetFont('Times','B',8);
		$this->Cell(20,7,''.$school_info_school_contact_no,0,0,'L');
		$this->Ln(-75);
