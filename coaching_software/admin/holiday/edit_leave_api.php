...
$query="update student_leave_management set student_name='$student_name',student_father_name='$student_father_name',student_contact_number='$student_contact_number',student_roll_no='$student_roll_no',leave_from_date='$leave_from_date_1',leave_to_date='$leave_to_date_1',leave_approved_by='$leave_approved_by',leave_total_day='$leave_total_day',image='$image1',$update_by_update_sql  where s_no='$s_no1'";
