...
$query="insert into student_leave_management(student_name,student_father_name,student_contact_number,student_roll_no,leave_from_date,leave_to_date,leave_approved_by,leave_total_day,$update_by_insert_sql_column,session_value) values ('$student_name','$student_father_name','$student_contact','$student_roll_no','$leave_from_date_1','$leave_to_date_1','$approved_by','$total_leave_days',$update_by_insert_sql_value,'$session1')";

if(mysqli_query($conn37,$query)){
  $s_no=mysql_insert_id();
				
$query11="insert into leave_document(s_no) values('$s_no')";
