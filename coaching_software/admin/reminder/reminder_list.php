...
<tr  align='center' >
	...
	<td><button type="button"  onclick="post_content('reminder/reminder_edit','<?php echo 'id='.$s_no; ?>')" class="btn btn-default my_background_color" ><?php echo $language['Edit']; ?></button></td><td>
