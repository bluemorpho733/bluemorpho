<?php include("../attachment/session.php");
	...
	if(mysqli_query($conn37,$quer125)){
		...
		if(mysqli_query($conn37,$quer126)){
			$quer127="update ledger_info set ledger_status='Deactive',$update_by_update_sql where emp_id_or_student_roll_no='$student_roll_no' and session_value='$session1'";
			if(mysqli_query($conn37,$quer127)){
				echo "|?|success|?|";
			}
		}
	}
