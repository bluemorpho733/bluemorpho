 ...
 <section class="content-header">
    ...
    <section class="content">
      ...
      <div class="box-header with-border">
        <h3 class="box-title">Return Book Detail</h3>
      </div>
          ...
          <thead class="my_background_color">
            <tr>
              <th>S.No</th>
    				  ...
    				  <th>Borrower's Id</th>
    				  <th>Borrower's Course & Subject</th>
    				  <th>Book Title</th>
    				  <th>Author</th>
              <th>Issued Date</th>
              <th>Due Date</th>
...
while($row=mysqli_fetch_assoc($ex)){
	...
	?>
			...
			<th>
			<button type="button" class="btn btn-default my_background_color" onclick="return valid('<?php echo $id; ?>');" ><?php echo $language['Delete']; ?></button></th>  
			</tr>
      <?php } ?>
               </tbody>
             </table>
