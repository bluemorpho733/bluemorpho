        ...
        $.ajax({
			...
			$('#modal-default').modal('hide');
			   ...
			   if(res[1]=='success'){
				  ...
				  location.reload();
				  //window.open('view_issued_book_list','_self');
    ...
    <div class="box-body table-responsive">
		<table id="example1" class="table table-bordered table-striped">
			...
			<?php 
				...
				$serial_no=0;
				$ex=mysqli_query($conn37,$sql)or die(mysqli_error($conn37));
			...
			?>
					...
					?>-->
						...
						<td><button type="button" name="finish" class="btn btn-default" value="<?php echo $student_roll_no; ?>" onclick="open_model(this.value)" data-toggle="modal" data-target="#modal-default" id="student_roll_no">Return</td>
				   </tr>
				<?php } ?>
			</tbody>
		</table>
