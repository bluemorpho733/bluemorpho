...
$("#my_form").submit(function(e){
	...
	$.ajax({
	url: access_link+"one_time_details/register_priority_api.php",
	type: "POST",
	data: formdata,
	...
	get_content('one_time_details/register_priority');
...
<li class="active">Register Priority</li>
</ol>
</section>
...
<tbody>
<?php
$register_column_name="s_no,register_name,register_code,register_priority";
...
<td><input type="number" name="register_priority[]" value="<?php echo $register_priority; ?>" class="form-control" /></td>
</tr>
<?php } ?>
</tbody>
