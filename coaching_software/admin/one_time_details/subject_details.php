...
$("#my_form").submit(function(e){
	...
	//$("#subject-add-modal").modal("hide");
	//window.scrollTo(0, 0);
	//get_content(loader_div);
	$.ajax({
	url: access_link+"one_time_details/add_subject_api.php",
	type: "POST",
	data: formdata,
	...
	get_content('one_time_details/subject_details');
...
function for_edit_subject(s_no,subject_name){
$("#s_no").val(s_no);
...
$("#my_form_edit").submit(function(e){
	...
	//get_content(loader_div);
	$.ajax({
	url: access_link+"one_time_details/edit_subject_api.php",
	type: "POST",
	data: formdata,
	mimeTypes:"multipart/form-data",
	contentType: false,
...
<h3 class="box-title pull-right"><a href="javascript:get_content('one_time_details/subject_priority')"><button class="btn my_background_color">Set Priority</button></a>
<button class="btn my_background_color" data-toggle="modal" data-target="#subject-add-modal">Add Subject</button></h3>
<span style="display:none;"><button class="btn my_background_color" id="for_open_edit_modal" data-toggle="modal" data-target="#subject-edit-modal">Edit Subject</button></span>
</div>
...
<?php
$subject_column_name="s_no,subject_name,subject_code,subject_priority,updated_by,updated_date";
...
$updated_by = $subject_row['updated_by'];
$updated_date=date('d-m-Y h:i:s',strtotime($subject_row['updated_date']));
...
<td><button class="btn my_background_color" onclick="for_edit_subject('<?php echo $s_no; ?>','<?php echo $subject_name; ?>');" >Edit/Delete</button></td>
</tr>
<?php } ?>
</table>
</div>
...
<div class="modal fade" id="subject-add-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
<form role="form" method="post" id="my_form" enctype="multipart/form-data">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header my_background_color">
        <span class="modal-title" id="exampleModalLongTitle">Subject Details</span>
...
<div class="modal fade" id="subject-edit-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
