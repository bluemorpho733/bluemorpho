            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped" style="width: 1301px; overflow: auto;">
                ...
                <tr>
                  ...
                  <th><?php echo $language['Class']; ?> : <?php echo $class; ?> / <?php echo $language['Section']; ?> : '<?php echo $section; ?>'<input typt="text" name="student_class" id="student_class" value="<?php echo $class; ?>" style="display:none;" /><input typt="text" name="student_section" id="student_section" value="<?php echo $section; ?>" style="display:none;" /></th>
                </tr>
                </thead>
                <tbody id="stud_list">
                <tr>
