...
<head>
 <meta charset="utf-8">
    ...
    <title>Student Attendance Form, School Attendance Management Software (Simption School Management Software</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	 ...
	 <li><a href="../index.php"><i class="fa fa-dashboard"></i> Home</a></li>
	  ...
	  <li><a href="student_attendance_select.php"><i class="fa fa-child"></i> Student Attendance Select</a></li>
	 <li class="active">Student Attendance Form</li>
      </ol>
    </section>
		...
		<div class="col-xs-8">
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
			  ...
			  <div class="col-md-4"><h4>Class : <?php echo $attendance_student_class; ?> / Section : '<?php echo $section; ?>'</h4></div>
			  <div class="col-md-2"></div>
			  </div>
			  <div class="col-md-12">
			  <table id="example1" class="table table-bordered table-striped">
				...
				$que="select * from student_attendance where attendance_class='$attendance_student_class' and attendance_section='$section' and month='$month' and year='$year' and session_value='$session1' order by student_name ASC";
...
$col_name='intime_'.$attendance_student_date4;

$count=count($unique_id);
for($i=0;$i<$count;$i++){

$query="update student_attendance set `$col_name`='$in_time', `$attendance_student_date4`='$student_attendance[$i]',$update_by_update_sql where attendance_class='$attendance_student_class' and attendance_section='$section' and month='$month' and year='$year' and attendance_roll_no='$unique_id[$i]' and session_value='$session1'";
if(mysqli_query($conn37,$query)){
echo "<script>window.open('student_attendance_list.php?class=$attendance_student_class&current_month=$month&year=$year&date=$attendance_student_date&section=$section','_self');</script>";
}
