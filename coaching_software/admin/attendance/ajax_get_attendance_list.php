...
$quer="select * from student_attendance where `$column_name`!='0000-00-00 00:00:00' and month='$current_month1' and year='$current_year1' and session_value='$session1' ORDER BY `$column_name` DESC";
...
$attendance_section = $row['attendance_section'];
...
<th><?php echo $attendance_name; ?></th>
<th><?php echo $attendance_class." / '".$attendance_section."'"; ?></th>
