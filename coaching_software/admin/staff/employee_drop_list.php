...
?>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Employee Drop List</h3>
            </div>
            <!-- /.box-header -->
...
$emp_photo = $row1['emp_photo'];
        ...
        <td><button type="button"  class="btn btn-info" onclick="return for_rejoin('<?php echo $s_no; ?>');" >Re - join</button></td>
				<td><a target="_blank" href='<?php echo $pdf_path; ?>salary_slip/<?php echo $experience_letter_pdf; ?>?s_no=<?php echo $s_no; ?>'><button type="button" class="btn btn-default my_background_color"><?php echo $language['Print']; ?></button></a></td>
        <td style="display:none;"><button type="button"  onclick="post_content('staff/employee_edit','<?php echo 's_no='.$s_no; ?>')" class="btn btn-default my_background_color" ><?php echo $language['Edit']; ?></button></td>
