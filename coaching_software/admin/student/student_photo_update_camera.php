...
<head>
 <meta charset="utf-8">
    ...
    <title>Student Action, School Student Management Software (Simption School Management Software</title>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-6 ">				
				...
				<div class="col-md-12">
				  ...
				  <div class="col-md-6">
				    <button type="button" id="student" onclick="get_identity(this.id);" class="btn btn-default my_background_color form-control" data-toggle="modal" data-target="#myModal" disabled>Take Student Photo</button>
				  </div>
				   <div class="col-md-6">
				      <button type="button" id="parent" onclick="get_identity(this.id);" class="btn btn-default my_background_color form-control" data-toggle="modal" data-target="#myModal"disabled >Take Parent Photo</button>
				  </div>
...
<div id="myModal" class="modal fade" role="dialog">
 ...
 <input type="hidden" class="form-control" name="student_roll_no6" id="student_roll_no6">
	 ...
	 <img  id="show_parent_photo" height="250" width="250" style="margin-top:10px;"> </center>
	 	...
	 	<input style="display:none;" type="submit" id="submit_photo_button" name="submit_photo" value="Submit" class="btn  my_background_color" />
      </div>
	  </form>
	  <div id="img_list" style="display:none;" class="col-sm-10 col-sm-offset-1">
