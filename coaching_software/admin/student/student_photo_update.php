...
$.ajax({
type: "POST",
url: access_link+"student/ajax_student_photo_update.php?student_class="+student_class+"&student_class_section="+student_class_section+"&student_limit="+student_limit+"",
success: function(detail){
