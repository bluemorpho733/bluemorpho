...
function Table1()
{
 global $student_name,$student_class,$student_roll_no,$student_father_name,$student_class_section;
	...
	if($class_name=='all'){
	$condition="where $filter_type='$filter_name'";
	}elseif($section_name=='all'){
	$condition="where student_class='$class_name' and $filter_type='$filter_name'";
	}else{
	$condition="where student_class='$class_name' and student_class_section='$section_name' and $filter_type='$filter_name'" ;
	}
    ...
    $this->Cell(30,7,"".$student_class,1,0,'C');
    $this->Cell(20,7,"".$student_class_section,1,0,'C');
    $this->Ln();
...
$section_name=$_GET['section'];
$filter_type=$_GET['filter_type'];
$file_name="student_list_".$filter_type."_".$class_name."_".$section_name.".pdf";
