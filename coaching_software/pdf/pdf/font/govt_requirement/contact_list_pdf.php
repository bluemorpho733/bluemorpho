 ...
 $logo_image='../../../documents/school_info/'.$school_info_logo;
	...
	$section_name=$_GET['section'];
		...
		$this->Image($logo_image,15,13,16,17);
		 ...
		 $this->Cell(50,10,"MOBILE NUMBER",1,0,'C');
		 $this->Ln();
}
...
function Table1()
{
 global $student_name,$student_father_contact_number,$student_roll_no,$student_father_name;
    ...
    $this->Cell(50,7,"".$student_father_contact_number,1,0,'C');
    $this->Ln();
...
$class_name=$_GET['class'];
$section_name=$_GET['section'];
$file_name="student_contact_".$class_name."_".$section_name.".pdf";
