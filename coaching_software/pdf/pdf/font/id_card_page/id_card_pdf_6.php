...
if($horizontal>2 && $vertical>1){
  ...
  $width=$width1*$horizontal;
		...
		$this->Image('../id_card_image/id_card_full_background_3.jpg',10+$width,10+$height,52,82);
		
		$this->Image('../id_card_image/id_card_background_header_3.png',10+$width,10+$height,52,10.5);
		...
		$this->Image('../id_card_image/id_card_background_footer_3.png',10+$width,80+$height,52,12);	
